...
Technology continues to grow at an exponential rate and organisations are utilising it to enhance productivity, improve customer experience, and generate profits(Dewett and Jones, 2001). The healthcare industry is also integrating technology into its processes. However, Wu et al. (2011) discovered that medical practitioners are often concerned about the risks and uncertainties associated with adopting new medical technology. This is because hospitals directly relate to the health and well-being of their patients, and practitioners are responsible for their patients' lives. As a result, medical practitioners tend to adopt technology much later, when it has become more mature and widely accepted. Nevertheless, Chau and Hau (2002), contends that medical practitioners should view technology as a medium to support highly specialised tasks, which can help to reduce costs and restructure processes. In some cases, failure to adopt technology, especially for managing customer information exchange and improving customer experience, may lead to loss of customers (Kluge, 2007).

As technology continues to integrate with the healthcare industry, it is crucial to recognize its impact on decision-making and policy creation. This underscores the importance of understanding healthcare workers' tendencies to adopt new technology. 

Therefore, this paper aims to identify the pertinent factors that influence healthcare workers' tendency to adopt new technology across two (2) datasets, visualise the relationships between these factors but most importantly, employ statistical methodologies to develop machine models that capture these factors and accurately predict the adoption of the new technology. Ultimately, a comparative analysis of these predictive models will be conducted, and recommendations will be provided based on the findings.
...
# 2.1 Data Available and Variables Selected
...
# 3.0 Results and Discussion (Dataset A)
...
# 3.1 Model 1: Model building and Assumption for Logistic Regression
...
## 3.2 Model 2: Model building and cross-validation for KNN
...
## 3.3 MODEL 3: Model building and cross-validation for Naive-Bayes
...
## 3.4 COMPARISON OF THE THREE MODELS FOR DATASET A
...
## 4.0 Results and Discussion (Dataset B)
...
## 5.0 Visualisation and Analysis on Alternate dataset
